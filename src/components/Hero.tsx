  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 mix-blend-overlay dark:opacity-10" style={{ backgroundSize: 'cover' }}></div>
      ...
      {isMounted && (
        ...
        >
          ...
          <motion.div 
            ...
            className="absolute transform -bottom-24"
          >
            <a
              href="#about"
